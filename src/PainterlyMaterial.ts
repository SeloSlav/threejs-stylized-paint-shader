...
float pigmentEmphasis = clamp( uPigmentContrast / 0.55, 0.0, 1.0 );
float pigmentBrokenLight = pigmentLight + ( pigmentStroke - 0.5 ) * 0.38 * uPainterliness * pigmentEmphasis;
...
float pigmentScumble = smoothstep( 0.52, 0.85, pigmentDeposit.a ) * pigmentLit * uDetailStrength * pigmentEmphasis;
