...
export type SceneId = 'material-study' | 'tier-one-residence' | 'seedthree-beech' | 'cc0-man';
...
export const PAINT_SCENES: readonly PaintSceneDefinition[] = [
  ...
  },
  {
    ...
    eyebrow: 'SCENE 04 · RIGGED CC0 ASSET',
